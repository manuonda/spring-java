...
/**
 * Se debe respetar the name GatewayFilterFactory
 * 
 * @author manuonda
 *
 */
...
public class EjemploGatewayFilterFactory
	...
	public GatewayFilter apply(Configuracion config) {
		...
		return (exchange, chain) -> {
			...
			// prefilter y dentro del filter es post
	...
	public static class Configuracion {
		...
		public Configuracion(String mensaje, String cookieValor, String cookieNombre) {
			super();
